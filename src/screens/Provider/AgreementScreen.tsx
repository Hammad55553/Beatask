        ...
        <SafeAreaView style={isDarkMode ? darkStyles.container : lightStyles.container}>
            <ScrollView contentContainerStyle={isDarkMode ? darkStyles.scrollContainer : lightStyles.scrollContainer}>
                <View style={isDarkMode ? darkStyles.content : lightStyles.content}>
                    <Text style={isDarkMode ? darkStyles.text1 : lightStyles.text1}>This Independent Contractor Agreement ("Agreement") is made effective as of today, by and between ASPERTASK LLC app users, facilitated by ASPERTASK LLC ("Recipient"), of 1942 Broadway St. STE 314C, Boulder, Colorado 80302, and Independent contractors registered on the ASPERTASK platform ("Contractor").</Text>
                    ...
                    <Text style={isDarkMode ? darkStyles.text : lightStyles.text}>Services available on the ASPERTASK platform include, but are not limited to:</Text>
                    ...
                    <Text style={isDarkMode ? darkStyles.text : lightStyles.text}><Icon name="circle" size={hp('1.2%')} style={isDarkMode ? darkStyles.bulletIcon : lightStyles.bulletIcon} />  Once the service is completed, the consumer will mark the project as completed on the ASPERTASK platform.</Text>
                    ...
                    <Text style={isDarkMode ? darkStyles.text : lightStyles.text}><Icon name="circle" size={hp('1.2%')} style={isDarkMode ? darkStyles.bulletIcon : lightStyles.bulletIcon} />  Duration: This Agreement remains in effect as long as the Service Provider continues to offer services on the ASPERTASK platform and complies with the terms of this Agreement.</Text>

                    <Text style={isDarkMode ? darkStyles.text : lightStyles.text}><Icon name="circle" size={hp('1.2%')} style={isDarkMode ? darkStyles.bulletIcon : lightStyles.bulletIcon} />  Termination by the Company: ASPERTASK LLC may terminate this Agreement at any time, with or without cause, by providing written notice to the Service Provider.</Text>

                    <Text style={isDarkMode ? darkStyles.text : lightStyles.text}><Icon name="circle" size={hp('1.2%')} style={isDarkMode ? darkStyles.bulletIcon : lightStyles.bulletIcon} />  Termination by the Service Provider: The Service Provider may terminate this Agreement at any time by providing written notice to ASPERTASK LLC</Text>
                    ...
                    <Text style={isDarkMode ? darkStyles.text : lightStyles.text}><Icon name="circle" size={hp('1.2%')} style={isDarkMode ? darkStyles.bulletIcon : lightStyles.bulletIcon} />  TEffect of Termination: Upon termination, the Service Provider will cease offering services through the ASPERTASK platform. Outstanding payments for completed services will be processed according to the agreed terms</Text>
