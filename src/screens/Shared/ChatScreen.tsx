        ...
        <View style={[styles.container, { backgroundColor: colorScheme === 'dark' ? '#010A0C' : '#fff' }]}>
            {showTopPopup && (
                <View style={styles.topPopup}>
                    ...
                    <Text style={styles.popupTitle}><Icons name="info" size={20} color="#EEB0B0" style={styles.infoIcon} /> ASPERTASK REMINDER</Text>
                    <Text style={styles.popupText}>
                        Do not share personal information or make payments outside the ASPERTASK app. All transactions and communications must be conducted within the app to ensure your safety. ASPERTASK will not be responsible for any losses or issues arising from off-app dealings. Our official team will never contact you through unofficial channels. Please be cautious!
                    </Text>
